...
function [allt,y,trtimes,keyval]= flicker_var_iti_pil2(flicker,contrast, scanner)
try 
Screen('Preference', 'SkipSyncTests', 1)
KbName('UnifyKeyNames')
fpath='/home/lewislab/stimuli/logfiles/';
c=clock;
fname=sprintf(['%spilot2' contrast '_SW_vZ%02.0f-%02.0f-%02.0f_%02.0f-%02.0f-%02.0f.mat'],fpath,c);
mname=sprintf(['%spilot2' contrast '_SW_vZ%02.0f-%02.0f-%02.0f_%02.0f-%02.0f-%02.0f.m'],fpath,c);
bname=sprintf(['%spilot2' contrast '_SW_vZ%02.0f-%02.0f-%02.0f_%02.0f-%02.0f-%02.0f.mat'],fpath,c);
...
% dur * freq = 648 for 54 sec duration 
allstim = [648 648 648 648 ] %648 648 648]
